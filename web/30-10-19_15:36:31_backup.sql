...
INSERT INTO `appointment` VALUES (1,'contract ','2018-01-01','2018-12-31',2,'2018-11-09 10:33:21','2018-11-09 05:06:13',1),(2,'lecture bases','2018-11-01','2019-11-29',3,'2018-11-09 10:35:15','2018-11-09 05:06:20',1),(3,'lecture bases','2019-02-16',NULL,4,'2019-02-18 12:27:45','2019-02-18 06:57:45',1),(4,'permanent','2019-10-07',NULL,5,'2019-10-30 15:02:36','2019-10-30 09:32:36',1),(5,'contract ','2019-10-08',NULL,6,'2019-10-30 15:03:34','2019-10-30 09:33:34',1),(6,'lecture bases','2019-09-30',NULL,7,'2019-10-30 15:14:32','2019-10-30 09:44:32',1),(7,'lecture bases','2019-10-01',NULL,8,'2019-10-30 15:15:59','2019-10-30 09:45:59',1),(8,'lecture bases','2019-10-30',NULL,9,'2019-10-30 15:27:31','2019-10-30 09:57:31',1),(9,'lecture bases','2019-10-30','2019-10-24',10,'2019-10-30 15:32:38','2019-10-30 10:02:38',1),(10,'lecture bases','2019-10-09','2019-11-02',11,'2019-10-30 15:36:30','2019-10-30 10:06:30',1);
...
CREATE TABLE `auditing_member` (
  ...
  CONSTRAINT `auditing_member_ibfk_1` FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`faculty_id`),
...
INSERT INTO `auditing_member` VALUES (1,'dkjd','2019-02-17','2019-02-17','fjjf\r\n','ff',2,'fff',1,2,'2019-02-17 21:55:42','2019-02-17 16:25:42',NULL,NULL,NULL,NULL);
...
INSERT INTO `bos` VALUES (1,'techweek.','dggdgddkdkd/dkd/djgggg','2018-09-03',NULL,1,1,'2018-09-03 20:49:36','2018-09-05 06:44:22'),(2,'irix','a/b/v/','2018-09-25',NULL,1,3,'2018-09-09 22:00:02','2018-09-09 16:30:02');
...
CREATE TABLE `event` (
  ...
  CONSTRAINT `event_ibfk_1` FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`faculty_id`)
...
INSERT INTO `event` VALUES (5,'gemine','Chowgules',1,78999,'7000',NULL,NULL,2,'qwwee','aadd','2019-02-19','2019-03-07',1,2,'2019-02-15 21:33:08','2019-02-15 16:03:08',NULL,NULL,NULL,NULL),(6,'dd','ddd',1,33,'33',NULL,NULL,3,'333','33','2019-02-01','2019-02-28',1,3,'2019-02-15 21:47:24','2019-02-15 16:17:24',NULL,NULL,NULL,NULL),(7,'Technobit','Parvatibai Chowgule College Of Arts and Science',1,1000000,'250',NULL,NULL,2,'Wendham Grey, Dixita Aroskar','Dipesh Tamang, Qaiser Basha, Shubham Naique','2019-02-07','2019-02-08',1,2,'2019-02-20 21:11:49','2019-02-20 15:41:49',NULL,NULL,NULL,NULL);
...
CREATE TABLE `examiner` (
  ...
  CONSTRAINT `examiner_ibfk_1` FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`faculty_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `examiner` VALUES (1,'aa$query->andFilterWhere([\'like\', \'department.name',2,'dlkdjfjf','fjfljk','2019-02-18','2019-02-18',1,2,'2019-02-18 21:30:14','2019-02-18 16:00:14',NULL,NULL,NULL,NULL);
...
INSERT INTO `faculty` VALUES (1,'dsgd','hs222','222','aa','222','2018-09-05 13:12:50','2018-09-05 07:42:50',NULL),(2,'Castor Godinho','qaiserBasha@gmail.com','9876543210','H.no 239 \r\nsirvodem,margao\r\nSalcete\r\nGoa','4545454545','2018-11-09 10:33:21','2018-11-09 05:03:21',NULL),(3,'Wendham Gray','WendhamGray@gmail.com','9123456780','Ankur Luis,  Carmona , Salcete Goa','345678','2018-11-09 10:35:15','2018-11-09 05:05:15',NULL),(4,'Mic','A@SA','9887656765','asd','6543','2019-02-18 12:27:45','2019-02-18 06:57:45',NULL),(5,'Dipesh Tamang','tad004@gmail.com','99888666633','Margao, Goa','123455','2019-10-30 15:02:35','2019-10-30 09:32:35',NULL),(6,'Test','djd@skjls.com','9789798','kdkjjds','ksjk99u','2019-10-30 15:03:34','2019-10-30 09:33:34',NULL),(7,'dkl','ksj','09980','jjlj','lkdjjs','2019-10-30 15:14:31','2019-10-30 09:44:31',NULL),(8,'dkjal','dkjjd','909090','sks','fdkjldfj','2019-10-30 15:15:59','2019-10-30 09:45:59',NULL),(9,'jdkj','dkjd','009890','jjdjk','dh','2019-10-30 15:27:31','2019-10-30 09:57:31',NULL),(10,'kdshhhak','dhkshd','8797','shh','sdhk','2019-10-30 15:32:38','2019-10-30 10:02:38',NULL),(11,'sdkdsh','hdskkh','0990','djlja','ds','2019-10-30 15:36:30','2019-10-30 10:06:30',NULL);
...
INSERT INTO `internship` VALUES (1,6,37,2,'Google','2018-02-04','2019-04-18',40,'uploads/Auditing_Member/tcp.png',NULL,NULL,NULL),(2,6,40,2,'Oracle','2018-08-28','2018-10-16',20,'uploads/Auditing_Member/tcp.png',NULL,NULL,NULL);
...
CREATE TABLE `paper_published` (
  ...
  KEY `fac1` (`faculty_id`),
  CONSTRAINT `fac1` FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`faculty_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `paper_published` VALUES (1,'Test','test','2019-10-03',2,'dslk','skkl','2019-10-30 13:21:22','2019-10-30 07:51:22','uploads/event/journal.txt',NULL,NULL,NULL);
...
INSERT INTO `program` VALUES (6,'B.voc (Software development)',1,'2018-11-09 09:49:36','2019-09-01 13:33:36',1),(7,'B.Sc (Computer Science)',1,'2018-11-09 09:49:58','2019-09-01 13:34:10',1),(10,'M.Sc.IT',1,'2019-09-01 19:05:20','2019-09-01 13:35:20',1);
...
INSERT INTO `program_student` VALUES (34,6,37,'2018-11-09 09:54:32','2018-11-09 04:24:32',1,2),(35,6,38,'2018-11-09 09:55:13','2018-11-09 04:25:13',1,2),(36,6,39,'2018-11-09 09:56:02','2018-11-09 04:26:02',1,2),(37,6,40,'2018-11-09 09:56:33','2018-11-09 04:26:33',1,2),(38,6,41,'2018-11-09 09:57:16','2019-02-19 08:21:13',0,2),(39,6,42,'2018-11-09 09:58:01','2018-11-09 15:22:40',0,2),(40,NULL,43,'2019-02-19 15:52:32','2019-02-19 10:22:32',1,2),(41,10,44,'2019-09-01 19:07:12','2019-09-01 13:37:12',1,2),(42,10,45,'2019-09-01 19:10:36','2019-09-01 13:40:36',1,2),(43,6,46,'2019-09-12 11:34:38','2019-09-12 06:04:38',1,2);
...
CREATE TABLE `project` (
  ...
  CONSTRAINT `project_ibfk_1` FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`faculty_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `project` VALUES (1,'1','kljk','2019-02-17','2019-02-17',1,'8 days',899,2,'fff','ddd\r\n',NULL,1,2,'2019-02-17 22:08:51','2019-02-17 16:38:51',NULL,NULL,NULL,NULL);
...
INSERT INTO `seminar` VALUES (2,'Shubham Naique','2019-10-01','2019-10-02','10','Suresh, Rimmy,Harry','Castor Godinho','something something..','Chowgules',1,1,2,'2019-10-30 12:14:47','2019-10-30 06:44:47',NULL,NULL,NULL,NULL);
...
INSERT INTO `student` VALUES (37,'manisha solanki','VU172801','123456789','MAN000@gmail.com','2018-11-09 09:54:32','2018-11-09 04:34:22',1,1),(38,'shunbham naik','VU172802','987655222','shu000@gmail.com','2018-11-09 09:55:13','2018-11-09 15:04:53',1,1),(39,'Dipesh tamang','VU172803','123546','dip870@gmail.com','2018-11-09 09:56:02','2018-11-09 15:04:53',1,1),(40,'Qaiser Basha','VU172804','5765455434','qai575@gmail.com','2018-11-09 09:56:33','2019-02-21 09:53:53',1,1),(41,'Deepraj dessai','VU172805','4543444432','dipr654@gmail.com','2018-11-09 09:57:16','2019-02-19 08:21:13',0,0),(42,'Rahul nath','VU172806','45432435647','ral5454@gmail.com','2018-11-09 09:58:01','2018-11-09 04:33:00',1,1),(43,'ss','2233','uygwugd`','gsdgjdhd','2019-02-19 15:52:32','2019-02-19 10:22:32',1,0),(44,'Julia Micheals','SU112233','9988776655','julia@gmail.com','2019-09-01 19:07:12','2019-09-01 13:38:44',1,0),(45,'Steve Smith','SU69988','9698798900','steve@chowgules.ac.in','2019-09-01 19:10:35','2019-09-01 13:40:35',1,0),(46,'Rakesh Sharma','VU188222','9900775544','rakesh@gmail.com','2019-09-12 11:34:38','2019-09-12 06:04:38',1,0);
...
CREATE TABLE `student_activity` (
  ...
  CONSTRAINT `student_activity_ibfk_1` FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`faculty_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `student_activity` VALUES (1,NULL,NULL,NULL,NULL,'ddd',222,'2019-03-06','2019-02-16',3,'ffssd','ddd',NULL,1,2,'2019-02-16 14:06:23','2019-02-16 08:36:23');
...
INSERT INTO `student_organization` VALUES (2,1,37,'2018-10-28','manager',6,'2018-11-09 10:01:57','2018-11-09 04:31:57'),(3,1,42,'2018-11-20','manager',6,'2018-11-09 10:03:41','2018-11-09 04:33:41'),(5,2,37,'2018-11-01','asst-manager',6,'2018-11-09 20:43:21','2018-11-09 15:13:21'),(6,3,37,'2018-11-30','asd',6,'2018-11-09 20:44:57','2018-11-09 15:14:57'),(7,2,40,'2019-03-07','Developer ',6,'2019-02-21 15:18:57','2019-02-21 09:48:57'),(8,1,44,'2019-09-25','Junior Developer',10,'2019-09-01 19:24:15','2019-09-01 13:54:15');
...
CREATE TABLE `subject_expert` (
  ...
  CONSTRAINT `subject_expert_ibfk_1` FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`faculty_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `subject_expert` VALUES (5,2,1,2,'2019-02-17 23:10:06','2019-02-17 17:40:06'),(6,3,1,2,'2019-02-17 23:11:59','2019-02-17 17:41:59'),(8,1,1,2,'2019-02-17 23:16:28','2019-02-17 17:46:28');
...
INSERT INTO `users` VALUES (1,'qaiser','$2y$13$BBvQ7HRjK0CKmWnBiNGMp.5.Op7l.zNzHC0wjScpL6CAUXBuANwPm','2018-11-08 14:52:27','2018-11-08 09:22:27'),(5,'dipesh','$2y$13$Lw413L8Q9RT/XC47OnJGYuS7xuRUpVT5dYR2pBNCIqnzYj/PxYwpO','2019-09-12 11:25:55','2019-09-12 05:55:55');
...
CREATE TABLE `workshop` (
  ...
  CONSTRAINT `workshop_ibfk_1` FOREIGN KEY (`faculty_id`) REFERENCES `faculty` (`faculty_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `workshop` VALUES (1,'test',0,333,'111',NULL,NULL,'fljklfj',2,'kdkjd','2019-02-16','2019-02-16',1,2,'2019-02-16 13:48:30','2019-02-16 08:18:30',NULL,NULL,NULL,NULL);
...
-- Dump completed on 2019-10-30 20:06:32
