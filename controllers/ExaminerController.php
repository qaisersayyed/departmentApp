    ...
    public function actionCreate()
    {
        ...
        if(!Yii::$app->user->isGuest){
            if ($model->load(Yii::$app->request->post()) ){
                ...
                if ($model->file1 ) {       
                    $cnt = 1;
                    $filename =  'uploads/examiner/' . $model->file1 ->baseName . '.' . $model->file1 ->extension;
                    while (file_exists($filename)) {
                        $filename =  'uploads/examiner/' . $model->file1 ->baseName. $cnt . '.' . $model->file1 ->extension ; 
                        $cnt++;
                    }         
                ...
                if ($model->file2 ) {                
                    $cnt = 1;
                    $filename =  'uploads/examiner/' . $model->file2 ->baseName . '.' . $model->file2 ->extension;
                    while (file_exists($filename)) {
                        $filename =  'uploads/examiner/' . $model->file2 ->baseName. $cnt . '.' . $model->file2 ->extension ; 
                        $cnt++;
                    }         
                ...
                if ($model->file3 ) {                
                    $cnt = 1;
                    $filename =  'uploads/examiner/' . $model->file3 ->baseName . '.' . $model->file3 ->extension;
                    while (file_exists($filename)) {
                        $filename =  'uploads/examiner/' . $model->file3 ->baseName. $cnt . '.' . $model->file3 ->extension ; 
                        $cnt++;
                    }         
                ...
                if ($model->file4) {                
                    $cnt = 1;
                    $filename =  'uploads/examiner/' . $model->file4 ->baseName . '.' . $model->file4 ->extension;
                    while (file_exists($filename)) {
                        $filename =  'uploads/examiner/' . $model->file4 ->baseName. $cnt . '.' . $model->file4 ->extension ; 
                        $cnt++;
                    }         
