...
<div class="workshop-attended-form" style="width : 50%">

    <?php $form = ActiveForm::begin(); ?>

    <?= $form->field($model, 'workshop_title')->textInput(['maxlength' => true]) ?>
    ...
    <?php 
        ...
        $(document).ready(function(){
            $('#workshopattended-student_involved').change(function(){ // 
